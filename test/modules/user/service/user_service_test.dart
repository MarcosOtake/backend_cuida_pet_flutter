...
void main() {
  ...
  group('Group test loginWithEmailPassword', () {
    ...
    test('Should login with email and password and return UserNotfoundException', () async {
      //Arrange
      final email = 'rodrigorahman@gmail.com';
      final password = '123123';
      final supplierUser = false;
      when(() => userRepository.loginWithEmailPassword(
          email, password, supplierUser)).thenThrow(UserNotfoundException(message: 'Usuário não encontrado'));
      ...
      //Assert
      expect(() => call(
          email, password, supplierUser), throwsA(isA<UserNotfoundException>()));
      verify(() => userRepository.loginWithEmailPassword(
          email, password, supplierUser)).called(1);
    });
  });
